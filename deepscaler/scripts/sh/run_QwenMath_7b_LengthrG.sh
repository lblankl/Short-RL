...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='SimpleRLMath_QwenMath_7b_LengthrGep2' \
    ...
    trainer.default_local_dir="/mnt/danlongyuan/ShortR1/records/out/SimpleRLMath_QwenMath_7b_LengthrGep2" \
    trainer.reward_type=LengthrG \
