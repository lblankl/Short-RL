...
for eval_nppl in 2 3 4 5 6 7 8; do
    ...
    CUDA_VISIBLE_DEVICES=$((eval_nppl - 1)) PYTHONUNBUFFERED=1 python /mnt/danlongyuan/ShortR1/Logic-RL/eval_kk/main_eval_instruct.py --batch_size 8 --model ${model} --max_token ${max_token} \
