# model_path /volume/ailab4sci/ztgao/Logic-RL/~/experiments/gsm8k/ppo/RF++-Qwen-7B-1M-xppl-curriculum-002-i/actor
...
EXPERIMENT_NAME="RF++-xppl-curriculum-gamma-095"
...
for ppl in $PPL_VALUES; do
    ...
    MODEL_PATH="/volume/ailab4sci/txie/Logic-RL/~/experiments/gsm8k/ppo/${CURRENT_EXPERIMENT_NAME}/actor" # 替换为实际的保存路径
done
