...
import torch
from verl.utils.reward_score import gsm8k, math, multiply, countdown, kk, kk_kimi, kk_lengthr, kk_shortrl
...
def _select_rm_score_fn(data_source,config,data,tokenizer):
    if config.trainer.reward_type == 'default':
        ...
        return kk_shortrl.LengthRScorer(data,tokenizer,config)
    else:
        raise NotImplementedError
