...
Name=r42Reproduce-ShortRL-logic-standard-1e-6
SavePath=/volume/ailab4sci/txie/ydl/short_ablation2/$Name
...
nohup python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='ShortRL-logic' \
    ...
    trainer.reward_type=$reward_type > /volume/ailab4sci/txie/ydl/Short-RL/Logic-RL/sh/out/$Name 2>&1 &