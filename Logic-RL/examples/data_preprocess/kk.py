...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_type', type=str, default='3ppl')
    ...
    train_dataset = load_dataset(data_path,'train',split=args.data_type)
    test_dataset = load_dataset(data_path,'test',split=args.data_type)
